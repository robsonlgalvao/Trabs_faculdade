<?php
    ...
    include('conexao.php');
    $cpf=$_REQUEST['cpf'];
    $sql = "SELECT id,nome,cpf,telefone,materia FROM professor WHERE cpf=".$cpf;
    ...
    <section id="conteudo">
        ...
        <div id="contato">
            <fieldset>
               ...
               <form method="post" action="atualiza2cpf.php" >
                    <table align="center">
                    <tr>
                        <td>Id:</td><td><input type="number" name="num" value="<?php print $id; ?>" /></td>
                    </tr> 
                     <tr>
                        <td>Nome:</td><td><input type="text" name="nome" value="<?php print $nome; ?>" required/></td>
                    </tr> 
                    <tr>
                        <td>CPF:</td><td><input type="number" name="cpf" value="<?php print $cpf; ?>" required READONLY /></td>
                    </tr>
                    <tr>
