        ...
        <div id="contato">
            <fieldset>
               ...
               <form method="post" action="inserir2.php" >
                    <table align="center">
                    <!--<tr>
                        <td>Id:</td><td><input type="number" name="num" /></td>
                    </tr>--> 
                     <tr>
                        <td>Nome:</td><td><input type="text" name="nome" required/></td>
                    </tr> 
                    <tr>
                        <td>CPF:</td><td><input type="number" name="cpf" required/></td>
                    </tr>
                    <tr>
                        <td>Telefone:</td><td><input type="number" name="tel"/></td>
                    </tr>
                    <tr>
                    <td>Matéria</td><td><input type="text" name="mat" placeholder="Digite sua Matéria"/></td>
                    </tr>
                    <tr>
